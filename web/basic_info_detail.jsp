...
<%--			 <li> <i class="fa fa-newspaper-o pink "></i> <a href="#">外观情况</a></li>--%>
         </ul>
  </div>
  </div>
  </div>  
...
<script type="text/javascript">
    ...
    function info_detail_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            //1.发送异步请求到BrandDeleteServlet，并将品牌ID传过去执行删除
            $.post("InfoDetailDeleteServlet",{infoDetailId:id},function(res){
                //2.根据删除结果进行不同的提示
                if(res.code == 1000 ){
                    $(obj).parents("tr").remove();
                    layer.msg('已删除!',{
        ...
        if (res.code==1000){
            ...
            for (var j=0;j<detailArr.length;j++){
                ...
                var trStr = "<tr>" +
                    ...
                    "<a title='删除' href='javascript:;' onclick='info_detail_del(this,"+infoDetail.infoDetailId+")' class='btn btn-xs btn-danger' ><i class='fa fa-trash  bigger-120'></i></a>\n" +
                    "</td>" +
                    "</tr>";
