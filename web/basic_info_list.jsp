...
<div class="page-content clearfix">
    <div class="sort_style">
       ...
       <span class="l_f">
        <a href="javascript:;" id="sort_add" class="btn btn-warning"><i class="fa fa-plus"></i> 添加评估类目</a>
        <a href="javascript:;" class="btn btn-danger" onclick="basicInfoMultiDeleteSubmit()"><i class="fa fa-trash"></i> 批量删除</a>
       </span>
            <span class="r_f">${tips}</span>
        </div>
        <div class="sort_list">
            <form action="BasicInfoMultiDeleteServlet" method="post">
            <table class="table table-striped table-bordered table-hover" id="sample-table">
                ...
                <tr>
                    <td><label><input type="checkbox" class="ace" name="basicInfoId" value="${basicInfo.basicInfoId}"><span class="lbl"></span></label></td>
                    ...
                    <td class="td-manage">
                        <a title="编辑" href="BasicInfoQueryServlet?basicInfoId=${basicInfo.basicInfoId}" class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>
                        <a title="删除" href="javascript:;"  onclick="basic_info_del(this,${basicInfo.basicInfoId})" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
                    </td>
                </tr>
                </c:forEach>
                </tbody>
    ...
    <div class="">
        ...
        <ul>
            <li>
                ...
                <div class="col-sm-9">
                    <input name="basicInfoName" type="text" id="basicInfoName" placeholder="请输入新的类目名称" class="col-xs-10 col-sm-5" style="width: 500px;">
                </div>
            </li>
        </ul>
        </form>
...
<script type="text/javascript">
        ...
        layer.open({
            ...
            yes:function(index,layero){
                if ($("#basicInfoName").val()==""){
                    layer.msg("请输入类目名称！",{icon:5,time:1000});
                }else {
                    $("#form1").submit();
                }
            }
    ...
    /*广告图片-删除*/
    function basic_info_del(obj,id){
        layer.confirm('确认要删除吗？',{icon:0,},function(index){
            $.post("BasicInfoDeleteServlet",{basicInfoId:id},function (res) {
                if (res.code==1000){
    ...
    function basicInfoMultiDeleteSubmit() {
