...
<div class=" page-content clearfix">
    <div id="products_style">
        <div class="border clearfix">
            ...
            <a href="javascript:;" class="btn btn-danger" onclick="categoryMultiDeleteSubmit()"><i class="icon-trash"></i>批量删除</a>
            </span>
            <span>${tips}</span>
        </div>
        <div class="table_menu_list clearfix" id="testIframe" style="width:100%">
            <form action="CategoryMultiDeleteServlet" method="post">
            <table class="table table-striped table-bordered table-hover" id="sample-table" >
                ...
                <tr>
                    <td width="25px"><label><input type="checkbox" class="ace" name="categoryId" value="${category.categoryId}" ><span class="lbl"></span></label></td>
...
<%--                        <a onClick="member_stop(this,'10001')"  href="javascript:;" title="停用"  class="btn btn-xs btn-success"><i class="icon-ok bigger-120"></i></a>--%>
                        <a title="编辑" href="CategoryQueryServlet?categoryId=${category.categoryId}"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120"></i></a>
                        <a title="删除" href="javascript:;"  onclick="member_del(this,${category.categoryId})" class="btn btn-xs btn-warning" ><i class="icon-trash  bigger-120"></i></a>
                    </td>
                </tr>
                </c:forEach>
                </tbody>
...
<script type="text/javascript">
    ...
    function member_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            $.post("CategoryDeleteServlet",{categoryId:id},function (res) {
                if (res.code==1000){
    ...
    // 批量删除
    function categoryMultiDeleteSubmit() {
        layer.confirm('确认要删除吗？',function(index){
            var count = 0;
