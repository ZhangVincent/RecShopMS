            ...
            <form action="CategoryAddServlet" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
                ...
                <div class="clearfix cl" style="margin-top: 30px;">
                    <div class="Button_operation">
                        <button onClick="article_save_submit();" class="btn btn-primary radius" type="submit">提交保存</button>
                        <button onClick="layer_close();" class="btn btn-warning radius" type="button">&nbsp;&nbsp;取消&nbsp;&nbsp;</button>
                    </div>
                </div>
            </form>
        </div>
